...
if __name__ == "__main__":
    train_features = pd.read_csv("trainfeatures.csv", sep=' ', header=0).values
    train_labels = pd.read_csv("trainlabels.csv", sep=' ', header=0).values
    test_features = pd.read_csv("testfeatures.csv", sep=' ', header=0).values
    test_labels = pd.read_csv("testfeatures.csv", sep=' ', header=0).values
